<?php
/* Smarty version 3.1.31, created on 2019-04-03 21:59:45
  from "/home/sites/1a/7/7f76a77624/public_html/forms/themes/default/admin/modules/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5ca51ec1b26267_43886822',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1a33a0d2f4b9520ce7f33c53fea498fc71d59555' => 
    array (
      0 => '/home/sites/1a/7/7f76a77624/public_html/forms/themes/default/admin/modules/index.tpl',
      1 => 1537241520,
      2 => 'file',
    ),
  ),
...
function content_5ca51ec1b26267_43886822 (Smarty_Internal_Template $_smarty_tpl) {
...
" />
          <input type="checkbox" id="status_enabled" name="status[]" value="enabled" <?php if (in_array("enabled",$_smarty_tpl->tpl_vars['search_criteria']->value['status'])) {?>checked<?php }?> />
            <label for="status_enabled"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_enabled'];?>
</label>
          <input type="checkbox" id="status_disabled" name="status[]" value="disabled" <?php if (in_array("disabled",$_smarty_tpl->tpl_vars['search_criteria']->value['status'])) {?>checked<?php }?> />
...
?refresh_module_list'" class="blue" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['LANG']->value['phrase_refresh_module_list'], ENT_QUOTES, 'UTF-8', true);?>
" />
    </p>
...
/"><?php echo mb_strtoupper($_smarty_tpl->tpl_vars['LANG']->value['word_select'], 'UTF-8');?>
          ...
          <td valign="top" class="del2" align="center">
            <?php if ($_smarty_tpl->tpl_vars['module']->value['is_installed'] == "yes") {?>
              <a href="#" onclick="return mm.uninstall_module(<?php echo $_smarty_tpl->tpl_vars['module']->value['module_id'];?>
...
" />
    ...
    <div id="premium_module_dialog" class="hidden">
      ...
      <div class="margin_bottom_large">
        <?php echo $_smarty_tpl->tpl_vars['LANG']->value['text_enter_license_key'];?>

      </div>
      <div class="license_key_panel">
        <span class="margin_right_large"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_license_key'];?>
</span>
