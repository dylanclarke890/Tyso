...
$hostname = General::loadField("g_db_hostname", "g_db_hostname", "shareddb-f.hosting.stackcp.net");
$db_name  = General::loadField("g_db_name", "g_db_name", "formtools-3639bd6f");
$port     = General::loadField("g_db_port", "g_db_port", "3306");
$username = General::loadField("g_db_username", "g_db_username", "formtools-3639bd6f");
$password = General::loadField("g_db_password", "g_db_password", "df10e3b8c2f5");
